...
Interactive diagrams for each section below along with a overview dashboard.

View the full interactive dashboard here: **<a href="../files/how-an-llm-actually-works/index.html" target="_blank" rel="noopener">Dashboard</a>**
...
Interactive: <a href="../files/how-an-llm-actually-works/01-two-machine-overview.html" target="_blank" rel="noopener">the two-machine overview</a>.
...
Interactive: <a href="../files/how-an-llm-actually-works/02-post-training-a4.html" target="_blank" rel="noopener">post-training, stage by stage</a>.
...
Interactive: <a href="../files/how-an-llm-actually-works/03-b5-tool-loop.html" target="_blank" rel="noopener">the two loops</a>.
...
Interactive: <a href="../files/how-an-llm-actually-works/04-attention-forward-pass.html" target="_blank" rel="noopener">attention and the forward pass</a>.
...
Interactive: <a href="../files/how-an-llm-actually-works/05-positional-encoding-rope.html" target="_blank" rel="noopener">position and RoPE</a>.
...
Full set of interactive diagrams: <a href="../files/how-an-llm-actually-works/index.html" target="_blank" rel="noopener">dashboard</a>.
